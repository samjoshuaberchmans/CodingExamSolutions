...
public class WordMachine1 {
    ...
    public static void main(String[] args) {
    	WordMachine1 object1 = new WordMachine1();
    	System.out.println("Hashmap out - " + OPERATIONS.get("+"));
    	System.out.println("Value - " + object1.solution("4 5 6 – 7 +"));
    }
}
